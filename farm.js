...
var CAT_DESC = {
  ...
  marketing:  'זהות ונראות, מתחרים, SWOT, המלצות הורים ודף נחיתה — הסיפור של בית הספר, כתוב ומעוצב.',
  generators: 'תעודות, מודעות גיוס, רקעים, ברכות וסטיקרים — עיצוב אחיד בזהות בית הספר, בלי מעצב.',
